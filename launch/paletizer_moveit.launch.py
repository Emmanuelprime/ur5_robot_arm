...
def generate_launch_description():
    ...
    joint_controllers_file = os.path.join(
        get_package_share_directory('paletizer'), 'config', 'ur5_controllers.yaml'
    )
    ...
    moveit_config = (
        MoveItConfigsBuilder("paletizer_robot", package_name="paletizer_moveit_config")
    ...
    rviz_config_path = os.path.join(
        get_package_share_directory("paletizer_moveit_config"),
        "config",
        "moveit.rviz",
    )
